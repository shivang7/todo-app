<template>
  <div>
    ...
    <ul>
      <draggable class="list-group" :list="tasks" group="tasks">
      <li class="task" v-for="(task,row) in tasks" v-bind:key="row" v-bind:style="{backgroundColor:task.color}"
